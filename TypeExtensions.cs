...
namespace Commerce.Api.Model
{
    public static class TypeExtensions
    {
        ...
        public static string ToStringConfigStyle(this decimal? value)
            => value?.ToString(Statics.ConfigNumberFormat);
        ...
        public static IEnumerable<Enum> GetFlags(this Enum value) => GetFlags(
            value,
            Enum.GetValues(value.GetType()).Cast<Enum>().ToArray()
        );


        public static IEnumerable<Enum> GetIndividualFlags(this Enum value) => GetFlags(
            value,
